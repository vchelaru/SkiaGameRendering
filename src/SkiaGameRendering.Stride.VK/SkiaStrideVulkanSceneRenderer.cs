...
namespace SkiaGameRendering.Stride.VK
{
    ...
    /// </para>
    /// </summary>
    public class SkiaStrideVulkanSceneRenderer : SceneRendererBase
    {
        /// <summary>The render target drawn into and composited every frame. No-op while null.</summary>
        public SkiaStrideVulkanRenderTarget2D? Canvas { get; set; }

        /// <summary>
        /// Raised once per frame, between <see cref="SkiaStrideVulkanRenderTarget2D.Begin"/> and
