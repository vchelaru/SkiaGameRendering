...
{
    /// <summary>
    /// Shared game logic for all platform samples. The backend is constructed by Program.cs and
    /// passed in - same shape as the WebGL sample's Game1, whose backend must be constructed and
    /// awaited (via <see cref="SkiaBackend.Ready"/>) before Run().
    /// </summary>
